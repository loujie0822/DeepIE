...
from run.spo_extraction.transformers_multi_label_span_char.data_loader import Reader, Feature
from run.spo_extraction.transformers_multi_label_span_char.train import Trainer
...
def get_args():
    ...
    args.cache_data = args.input + '/bert_char_cache_data_{}/'.format(str(args.max_len))
    return args
