...
from run.entity_relation_jointed_extraction.etl_bies_update.data_loader import Reader, Vocabulary, Feature
from run.entity_relation_jointed_extraction.etl_bies_update.train import Trainer
...
def main():
    ...
    trainer = Trainer(args, data_loaders, eval_examples, word_emb, ent_conf=BAIDU_ENTITY, spo_conf=BAIDU_BIES)
