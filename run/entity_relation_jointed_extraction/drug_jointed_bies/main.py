...
from run.entity_relation_jointed_extraction.drug_jointed_bies.data_loader import Reader, Vocabulary, Feature, \
    DRUG_RELATION, Example
from run.entity_relation_jointed_extraction.drug_jointed_bies.train import Trainer
...
if __name__ == '__main__':
    ...
    if args.train_mode == 'predict':
        ...
        if file_input:
            ...
            input_text = ['培美曲塞 800mg ivgtt方案化疗,方案化疗方案化疗,过程顺利方案化疗,过程顺利方案化疗,过程顺利方案化疗,过程顺利方案化疗,过程顺利,过程顺利方案化疗,过程顺利方案化疗,过程顺利方案化疗,过程顺利过程顺利方案化疗,过程顺利方案化疗,过程顺利方案化疗,过程顺利方案化疗,过程顺利 ']
