...
from run.DuIE.transformer_mpn_v3.data_loader import Reader, Feature
from run.DuIE.transformer_mpn_v3.train import Trainer
...
def get_args():
    ...
    # choice parameters
    parser.add_argument('--baidu_spo_version', type=str, default="v2")
    ...
    args.cache_data = args.input + '/transformer_mpn_v3_data_{}/'.format(str(args.max_len))
    return args
