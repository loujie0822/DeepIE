...
from deepIE.chip_ent.ent_mhs_pointer.data_loader_char import Reader, Feature
from deepIE.chip_ent.ent_mhs_pointer.train import Trainer
...
def get_args():
    ...
    args.cache_data = args.input + '/{}_stacked_span_cache_data_{}/'.format(str(args.bert_model).split('/')[1],
                                                                            str(args.max_len))
    return args
