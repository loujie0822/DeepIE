...
class SPODataset(Dataset):
    ...
    def _create_collate_fn(self):
        def collate(examples):
            ...
            batch_subject_labels, batch_span_labels = [], []
            ...
            batch_span_labels = span_padding(batch_token_ids, batch_span_labels, is_float=False,
                                             class_num=len(self.spo_config))
            if not self.is_train:
                return p_ids, batch_token_ids, batch_segment_ids, batch_span_labels
            else:

                return batch_token_ids, batch_segment_ids, batch_span_labels
